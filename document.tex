...
\date{Last Updated: October 19, 2024\\ Submission Deadline: November 7, 2024, 5pm}
...
\begin{document}
   ...
   \begin{tcolorbox}[title=\color{black}{\section{Q1}}, colback=white, colframe=black!30!white, boxrule=0.4mm, width=1\textwidth]\centering
    ...
    \centering
    \lstinputlisting[style=mypythonstyle, title=\textbf{\textcolor{blue}{Python Script: \texttt{q1.py}}}]{q1.py}
